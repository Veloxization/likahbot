...
class TestRemindersDAO(unittest.TestCase):
    ...
    def test_users_reminders_are_found_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date3, "time")
        self.reminders_dao.add_new_reminder(2345, 8765, "Test2", self.date2, "time")
        self.reminders_dao.add_new_reminder(1234, 8765, "Test3", self.date1, "time")
    ...
    def test_users_public_reminders_are_found_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")
        self.reminders_dao.add_new_reminder(1234, 8765, "Test2", self.date2, "time", is_public=True)
    ...
    def test_reminders_by_user_in_a_guild_are_found_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")
        self.reminders_dao.add_new_reminder(1234, 8765, "Test2", self.date2, "time")
    ...
    def test_public_reminders_by_user_in_a_guild_are_found_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")
        self.reminders_dao.add_new_reminder(1234, 8765, "Test2", self.date2, "time")
        self.reminders_dao.add_new_reminder(1234, 9876, "Test3", self.date3, "time", is_public=True)
    ...
    def test_all_reminders_in_a_guild_are_found_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")
        self.reminders_dao.add_new_reminder(2345, 9876, "Test2", self.date2, "time")
        self.reminders_dao.add_new_reminder(1234, 8765, "Test3", self.date3, "time")
    ...
    def test_all_public_reminders_in_a_guild_are_found_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")
        self.reminders_dao.add_new_reminder(2345, 8765, "Test2", self.date2, "time")
        self.reminders_dao.add_new_reminder(3456, 9876, "Test3", self.date3, "time", is_public=True)
    ...
    def test_public_reminders_created_outside_of_a_guild_cannot_be_found(self):
        self.reminders_dao.add_new_reminder(1234, None, "Test1", self.date1, "time", is_public=True)
        self.reminders_dao.add_new_reminder(2345, None, "Test2", self.date2, "time", is_public=True)
        rows = self.reminders_dao.get_public_reminders_in_guild(None)
        self.assertEqual(len(rows), 0)

    def test_expired_reminders_are_found_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")
        self.reminders_dao.add_new_reminder(2345, 8765, "Test2", self.expired1, "time")
        self.reminders_dao.add_new_reminder(3456, 7654, "Test3", self.expired2, "time")
    ...
    def test_reminder_is_found_correctly_by_id(self):
        db_id = self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")["id"]
    ...
    def test_reminder_is_edited_correctly(self):
        db_id = self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")["id"]
        self.reminders_dao.edit_reminder(db_id, "Test2", self.date2, True, 120, "date", 2)
        row = self.reminders_dao.get_reminder_by_id(db_id)
    ...
    def test_reminder_repeats_are_updated_correctly(self):
        db_id = self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.expired1, "time", repeats=2)["id"]
    ...
    def test_reminder_repeats_are_not_updated_if_repeats_reaches_zero(self):
        db_id = self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.expired1, "time")["id"]
        self.reminders_dao.update_reminder_repeats(db_id)
        self.reminders_dao.update_reminder_repeats(db_id)
        row = self.reminders_dao.get_reminder_by_id(db_id)
    ...
    def test_guild_reminders_are_deleted_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time")
        self.reminders_dao.add_new_reminder(2345, 8765, "Test2", self.date2, "time")
        self.reminders_dao.add_new_reminder(3456, 9876, "Test3", self.date3, "time")
    ...
    def test_reminders_with_zero_repeats_are_deleted_correctly(self):
        self.reminders_dao.add_new_reminder(1234, 9876, "Test1", self.date1, "time", repeats=-1)
        self.reminders_dao.add_new_reminder(1234, 8765, "Test2", self.date2, "time", repeats=0)
        self.reminders_dao.add_new_reminder(1234, 7654, "Test3", self.date3, "time", repeats=1)
