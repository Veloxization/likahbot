...
class TestVerificationQuestionService(unittest.TestCase):
    ...
    def test_all_guild_verification_questions_are_found_correctly(self):
        ...
        questions = self.verification_question_service.get_all_guild_verification_questions(1234)
        self.assertEqual(len(questions), 1)
        self.assertEqual(questions[0].question, "Test1?")

    def test_specific_verification_questions_are_found_correctly(self):
        self.verification_question_service.add_verification_question(1234, "Test?")
        questions = self.verification_question_service.get_all_guild_verification_questions(1234)
        questions = self.verification_question_service.get_verification_question(questions[0].db_id)
    ...
    def test_verification_questions_are_edited_correctly(self):
        ...
        self.verification_question_service.edit_verification_question(questions[0].db_id, "Test2?", 1)
        questions = self.verification_question_service.get_all_guild_verification_questions(1234)
    ...
    def test_verification_question_is_deleted_correctly(self):
        ...
        questions = self.verification_question_service.get_all_guild_verification_questions(1234)
        self.assertEqual(len(questions), 1)
        self.verification_question_service.delete_verification_question(questions[0].db_id)
        questions = self.verification_question_service.get_all_guild_verification_questions(1234)
    ...
    def test_guild_verification_questions_are_deleted_correctly(self):
        self.verification_question_service.add_verification_question(1234, "Test1?")
        self.verification_question_service.add_verification_question(2345, "Test2?")
        questions1 = self.verification_question_service.get_all_guild_verification_questions(1234)
        questions2 = self.verification_question_service.get_all_guild_verification_questions(2345)
        self.assertEqual(len(questions1), 1)
        self.assertEqual(len(questions2), 1)
        self.verification_question_service.delete_guild_verification_questions(1234)
        questions1 = self.verification_question_service.get_all_guild_verification_questions(1234)
        questions2 = self.verification_question_service.get_all_guild_verification_questions(2345)
