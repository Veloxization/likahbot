...
class TestGuildSettingService(unittest.TestCase):
    def setUp(self):
        ...
        self.setting_id = self.setting_service.add_setting("test", "testing")
        self.setting = self.setting_service.get_setting_default_value_by_id(self.setting_id)

    def tearDown(self):
        self.guild_setting_service.clear_guild_settings()
        self.setting_service.clear_settings()

    def test_guild_setting_is_found_correctly_by_id(self):
        guild_setting_id = self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_id(guild_setting_id)
        self.assertEqual(guild_setting.value, "testing1")

    def test_guild_setting_is_found_correctly_by_setting_name(self):
        self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_name(1234, "test")
        self.assertEqual(guild_setting.value, "testing1")
    ...
    def test_guild_setting_is_found_correctly_by_setting_id(self):
        self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_setting_id(1234, self.setting_id)
        self.assertEqual(guild_setting.value, "testing1")
    ...
    def test_guild_setting_is_added_correctly_by_setting_id(self):
        self.guild_setting_service.add_guild_setting_by_setting_id(1234, self.setting_id, "testing1")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_setting_id(1234, self.setting_id)
        self.assertEqual(guild_setting.value, "testing1")

    def test_guild_setting_is_edited_correctly_by_id(self):
        guild_setting_id = self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        self.guild_setting_service.edit_guild_setting_by_id(guild_setting_id, "testing2")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_id(guild_setting_id)
        self.assertEqual(guild_setting.value, "testing2")

    def test_guild_setting_is_edited_correctly_by_setting_id(self):
        self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        self.guild_setting_service.edit_guild_setting_by_setting_id(1234, self.setting_id, "testing2")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_name(1234, "test")
        self.assertEqual(guild_setting.value, "testing2")

    def test_guild_setting_is_edited_correctly_by_setting_name(self):
        self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        self.guild_setting_service.edit_guild_setting_by_setting_name(1234, "test", "testing2")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_name(1234, "test")
        self.assertEqual(guild_setting.value, "testing2")

    def test_editing_guild_setting_of_one_guild_does_not_affect_guild_setting_of_another_guild(self):
        self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        self.guild_setting_service.add_guild_setting_by_setting_name(2345, "test", "testing1")
        self.guild_setting_service.edit_guild_setting_by_setting_name(1234, "test", "testing2")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_name(2345, "test")
        self.assertNotEqual(guild_setting.value, "testing2")

    def test_guild_setting_is_deleted_correctly_by_id(self):
        guild_setting_id = self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        self.guild_setting_service.delete_guild_setting_by_id(guild_setting_id)
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_name(1234, "test")
        self.assertIsNone(guild_setting.db_id)

    def test_guild_setting_is_deleted_correctly_by_setting_id(self):
        self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        self.guild_setting_service.delete_guild_setting_by_setting_id(1234, self.setting_id)
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_name(1234, "test")
        self.assertIsNone(guild_setting.db_id)

    def test_guild_setting_is_deleted_correctly_by_setting_name(self):
        self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        self.guild_setting_service.delete_guild_setting_by_setting_name(1234, "test")
        guild_setting = self.guild_setting_service.get_guild_setting_value_by_name(1234, "test")
        self.assertIsNone(guild_setting.db_id)
    ...
    def test_all_settings_associated_with_a_given_guild_are_deleted_correctly(self):
        self.guild_setting_service.add_guild_setting_by_setting_name(1234, "test", "testing1")
        self.guild_setting_service.add_guild_setting_by_setting_name(2345, "test", "testing2")
        self.guild_setting_service.delete_guild_settings(1234)
        guild_setting1 = self.guild_setting_service.get_guild_setting_value_by_name(1234, "test")
        guild_setting2 = self.guild_setting_service.get_guild_setting_value_by_name(2345, "test")
