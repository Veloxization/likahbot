...
class UnverifiedReminderHistoryService:
    ...
    async def get_member_reminder_history(self, user_id: int, guild_id: int):
        ...
        rows = await self.unverified_reminder_history_dao.get_member_reminder_history(user_id, guild_id)
    ...
    async def add_to_member_reminder_history(self, user_id: int, reminder_id: int):
        ...
        await self.unverified_reminder_history_dao.add_to_member_reminder_history(user_id, reminder_id)
    ...
    async def delete_member_reminder_history(self, user_id: int, guild_id: int):
        ...
        await self.unverified_reminder_history_dao.delete_member_reminder_history(user_id, guild_id)
    ...
    async def delete_guild_reminder_history(self, guild_id: int):
        ...
        await self.unverified_reminder_history_dao.delete_guild_reminder_history(guild_id)

    async def clear_unverified_reminder_history(self):
        """Delete every single unverified reminder history record"""

        await self.unverified_reminder_history_dao.clear_unverified_reminder_history_table()
