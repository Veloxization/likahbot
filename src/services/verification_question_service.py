...
class VerificationQuestionService:
    ...
    def get_all_guild_verification_questions(self, guild_id: int):
        ...
        rows = self.verification_questions_dao.get_all_guild_verification_questions(guild_id)
        return [self._convert_to_entity(row) for row in rows]

    def get_verification_question(self, question_id: int):
        ...
        row = self.verification_questions_dao.get_verification_question(question_id)
    ...
    def add_verification_question(self, guild_id: int, question: str, priority: int = 0):
        ...
        self.verification_questions_dao.add_verification_question(guild_id, question, priority)
    ...
    def edit_verification_question(self, question_id: int, question: str, priority: int):
        ...
        self.verification_questions_dao.edit_verification_question(question_id, question, priority)
    ...
    def delete_verification_question(self, question_id: int):
        ...
        self.verification_questions_dao.delete_verification_question(question_id)

    def delete_guild_verification_questions(self, guild_id: int):
        ...
        self.verification_questions_dao.delete_guild_verification_questions(guild_id)

    def clear_verification_questions(self):
