...
class GuildSettingService:
    ...
    def _convert_to_entity(self, row):
        ...
        if not row:
            return None
        return GuildSettingEntity(row["id"], row["guild_id"], row["setting_id"], row["setting_value"])
    ...
    def get_guild_setting_value_by_id(self, guild_setting_id: int):
        ...
        row = self.guild_settings_dao.get_guild_setting_value_by_id(guild_setting_id)
    ...
    def get_guild_setting_value_by_name(self, guild_id: int, setting_name: str):
        ...
        row = self.guild_settings_dao.get_guild_setting_value_by_name(guild_id, setting_name)
        return self._convert_to_entity(row)
    ...
    def get_guild_setting_value_by_setting_id(self, guild_id: int, setting_id: int):
        ...
        row = self.guild_settings_dao.get_guild_setting_value_by_setting_id(guild_id, setting_id)
        return self._convert_to_entity(row)
    ...
    def add_guild_setting_by_setting_id(self, guild_id: int, setting_id: int, setting_value: str):
        ...
        row = self.guild_settings_dao.add_guild_setting_by_setting_id(guild_id, setting_id, setting_value)
        return row["id"]
    ...
    def add_guild_setting_by_setting_name(self,
        ...
        row = self.guild_settings_dao.add_guild_setting_by_setting_name(guild_id,
                                                                        setting_name,
                                                                        setting_value)
        return row["id"]
    ...
    def edit_guild_setting_by_id(self, guild_setting_id: int, setting_value: str):
        ...
        self.guild_settings_dao.edit_guild_setting_by_id(guild_setting_id, setting_value)
    ...
    def edit_guild_setting_by_setting_id(self, guild_id: int, setting_id: int, setting_value: str):
        ...
        self.guild_settings_dao.edit_guild_setting_by_setting_id(guild_id, setting_id, setting_value)
    ...
    def edit_guild_setting_by_setting_name(self,
        ...
        self.guild_settings_dao.edit_guild_setting_by_setting_name(guild_id,
                                                                   setting_name,
                                                                   setting_value)
    ...
    def delete_guild_setting_by_id(self, guild_setting_id: int):
        ...
        self.guild_settings_dao.delete_guild_setting_by_id(guild_setting_id)
    ...
    def delete_guild_setting_by_setting_id(self, guild_id: int, setting_id: int):
        ...
        self.guild_settings_dao.delete_guild_setting_by_setting_id(guild_id, setting_id)
    ...
    def delete_guild_setting_by_setting_name(self, guild_id: int, setting_name: str):
        ...
        self.guild_settings_dao.delete_guild_setting_by_setting_name(guild_id, setting_name)
    ...
    def delete_guild_settings(self, guild_id: int):
        ...
        self.guild_settings_dao.delete_guild_settings(guild_id)

    def clear_guild_settings(self):
