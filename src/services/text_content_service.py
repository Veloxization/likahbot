...
class TextContentService:
    ...
    async def get_guild_text_contents(self, guild_id: int):
        ...
        rows = await self.text_contents_dao.get_guild_text_contents(guild_id)
    ...
    async def get_guild_text_contents_by_type(self, guild_id: int, content_type: str):
        ...
        row = await self.text_contents_dao.get_guild_text_contents_by_type(guild_id, content_type)
    ...
    async def create_text_content(self, guild_id: int, content: str = None, content_type: str = None):
        ...
        await self.text_contents_dao.create_text_content(guild_id, content, content_type)
    ...
    async def edit_text_content(self, guild_id: int, content_type: str, content: str = None):
        ...
        await self.text_contents_dao.edit_text_content(guild_id, content_type, content)
    ...
    async def delete_text_content(self, guild_id: int, content_type: str):
        ...
        await self.text_contents_dao.delete_text_content(guild_id, content_type)
    ...
    async def delete_guild_text_contents(self, guild_id: int):
        ...
        await self.text_contents_dao.delete_guild_text_contents(guild_id)

    async def clear_text_contents(self):
        """Delete all text contents"""

        await self.text_contents_dao.clear_text_contents_table()
